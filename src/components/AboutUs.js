    ...
    <>
      <section className={styles.how}>
        ...
        <Marquee className={styles.marquee} pauseOnHover={true} gradient={false} speed={60}>
          <Image src="/asset/banner/2.jpg" alt="Sindhu's Kitchen" className={styles.bannerImg} width={300} height={150} priority />
          <Image src="/asset/banner/1.jpg" alt="Sindhu's Kitchen" className={styles.bannerImg} width={300} height={150} priority />
          <Image src="/asset/banner/2.jpg" alt="Sindhu's Kitchen" className={styles.bannerImg} width={300} height={150} priority />
          <Image src="/asset/banner/1.jpg" alt="Sindhu's Kitchen" className={styles.bannerImg} width={300} height={150} priority />
          <Image src="/asset/banner/2.jpg" alt="Sindhu's Kitchen" className={styles.bannerImg} width={300} height={150} priority />
          <Image src="/asset/banner/1.jpg" alt="Sindhu's Kitchen" className={styles.bannerImg} width={300} height={150} priority />
      ...
      <section className={styles.about}>
        ...
        <div className={styles.aboutInner}>
          <div className={styles.left}>
            <Image src="/asset/banner/about.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={300} height={150} priority />
          </div>
      ...
      <section className={styles.special}>
        <h2>Why Sindhu’s</h2>
        <h3>What makes Sindhu’s Kitchen special</h3>
        <div className={styles.box}>
          <div className={styles.boxList}>
            <Image src="/asset/icon/water.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={60} height={60} priority />
            <h4>Pure Beginnings</h4>
            <p>Our culinary creations start with the purest water in all our food and snack preparation.</p>
          </div>
          <div className={styles.boxList}>
            <Image src="/asset/icon/oil.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={60} height={60} priority />
            <h4>Premium Oils</h4>
            <p>Exclusively cold-pressed Sesame and Peanut oils enhance our dishes.</p>
          </div>
          <div className={styles.boxList}>
            <Image src="/asset/icon/care.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={60} height={60} priority />
        ...
        <div className={styles.box}>
          <div className={styles.boxList}>
            <Image src="/asset/icon/fresh.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={60} height={60} priority />
          ...
          <div className={styles.boxList}>
            <Image src="/asset/icon/quality.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={60} height={60} priority />
            <h4>Quality Assurance</h4>
            <p>Rest assured, we never recycle our cooking oil, maintaining the highest quality standards.</p>
          </div>
          <div className={styles.boxList}>
            <Image src="/asset/icon/tradition.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={60} height={60} priority />
      ...
      <section className={styles.galary}>
        <h2>Sindhu’s Delicious Moments</h2>
      ...
      <section className={styles.testimonials}>
        <h2>What Our Customers Says About Our Food</h2>
        <div className={styles.inner}>
          <div className={styles.card}>
            <div className={styles.extra}>”</div>
            <Image src="/asset/man.png" alt="Sindhu's Kitchen" className={styles.aboutImg} width={60} height={60} priority />
            <h4>Nikul S.</h4>
